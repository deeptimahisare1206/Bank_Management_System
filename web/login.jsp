...
<html>
    ...
    <body class="text-teal-900 h-screen box-border bg-cover bg-sky-200 grid place-items-center">
        <div class="bg-white grid place-items-center px-6 py-4 gap-4">
            ...
            <form action="" class="flex flex-col gap-6 p-2 grid place-items-center ">
                <input type="text" name="name" placeholder="Account No." class="text-xl h-12 w-full outline-none px-2 py-1 border-b-2 border-teal-900 ">
